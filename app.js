...
client.on('message', async (message) => {
 ...
 // Este codigo verifica que ya se envio el mensaje de bienvenida
  ...
  if (!registro[message.from]) {
    ...
    client.sendMessage( message.from, '*¡Hola!* 👋 \n\nGracias por comunicarte con *SOPORTE* John Store. 🍿🎬 Queremos ofrecerte un servicio más exclusivo. Ahora, contarás con un asesor dedicado para cada plataforma.\n\n📲 Escribe 1 para Netflix.\n\n📲 Escribe 2 para otras plataformas.' )
